                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        type="email"
                        defaultValue="amina.kiptoo@example.com"
                        className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
                      />
                    </div>
                    <div>
                      ...
                      <textarea
                        defaultValue="Environmental advocate passionate about sustainable development and youth empowerment."
                        rows={4}
                        className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <button className="p-4 border-2 border-amber-600 rounded-lg bg-amber-50">
                          <div className="text-center">
                            <div className="w-8 h-8 bg-amber-600 rounded-full mx-auto mb-2"></div>
                            <span className="font-medium text-amber-800">Light</span>
                          </div>
                        </button>
                        <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-gray-300">
                          <div className="text-center">
                            ...
                            <span className="font-medium text-gray-600">Dark</span>
                          </div>
                        </button>
                        <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-gray-300">
                          <div className="text-center">
