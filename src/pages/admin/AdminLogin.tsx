      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Access the M-taji admin dashboard
          </p>
        </div>
        ...
        <div className="mt-8 p-4 bg-accent-light/10 rounded-lg">
          <p className="text-sm text-text-dark text-center">
            <strong>Demo Credentials:</strong><br />
            Email: admin@m-taji.org<br />
            Password: admin123
          </p>
        </div>
